        ...
        <Theme>
            <Box width={'100%'} height={'100vh'} display={'flex'} justifyContent={'center'} alignItems={'center'}>
                <Box width={400} height={300} bgcolor={'white'} borderRadius={6} display={'flex'} flexDirection={'column'} justifyContent={'space-around'} alignItems={'center'}>
                    ...
                    <TextField label={'password'} type={'password'} error={error} size={'small'} style={{ width: '75%' }} onChange={e => setPassword(e.target.value)} />
                    <TextField label={'repeat password'} type={'password'} error={error} size={'small'} style={{ width: '75%' }} onChange={e => setRepeatPassword(e.target.value)} />
