    ...
    return (
        <Box width={400} height={600} bgcolor={'#FFF'} borderRadius={6} display={'flex'} flexDirection={'column'} alignItems={'center'} justifyContent={'space-around'}>
            ...
            <Box display={'flex'} flexDirection={'column'} alignItems={'center'} width={'100%'}>
                ...
                <TextField error={error} size={'small'} type={'date'} style={{ width: '75%', marginTop: 20 }} value={ moment(emploee.dateBirthday).format("YYYY-MM-DD")} onChange={e => setEmploee({ ...emploee, dateBirthday: new Date(e.target.value) })} />
